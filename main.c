...
static __m128i INIT0;
static __m128i INIT1;

static inline __attribute__((always_inline)) void sha_step(void) {
    /* Load initial values */
    TMP = INIT0;
    STATE1 = INIT1;
    ...
    /* Save state */
    _mm_storeu_si128((__m128i*) &msg[0], STATE0);
    _mm_storeu_si128((__m128i*) &msg[16], STATE1);
}

int main(void) {
    MASK = _mm_set_epi64x(0x0c0d0e0f08090a0bULL, 0x0405060700010203ULL);
    INIT0 = _mm_set_epi64x(0xa54ff53a3c6ef372ULL, 0xbb67ae856a09e667ULL);
    INIT1 = _mm_set_epi64x(0x5be0cd191f83d9abULL, 0x9b05688c510e527fULL);
    ...
    msg[32] = 0x80; // sha256 padding
    msg[62] = 1; // 256 big-endian
